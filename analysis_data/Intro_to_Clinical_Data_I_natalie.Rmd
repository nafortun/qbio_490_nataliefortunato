...
```{r}
write.csv(clinic, "/Users/nataliefortunato/Documents/qbio_490_nataliefortunato/analysis_data/brca_clinical_data.csv", row.names=FALSE)
```

To read the csv back into your environment as a dataframe:

```{r}
clinic <- read.csv("/Users/nataliefortunato/Documents/qbio_490_nataliefortunato/analysis_data/brca_clinical_data.csv")
```
...
The 5th pateint is 18371 days old (50.3 years).
