...
```{r 2.2}
## don't run this
##setwd() # (ex: "/Users/nataliefortunato/Documents/qbio_490_nataliefortunato/sp23_course_material/week6_R")
...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/nataliefortunato/Documents/qbio_490_nataliefortunato/sp23_course_material/week6_R")) 
```
...
factor <- factor(c("Male", "Male", "Female", "Male", "Male", "Female")) 
factor
```
...
## bad names:
sum <- sum(numeric_vector) ## function name
s <- sum(numeric_vector) ## lacks info/description
sumofages <- sum(numeric_vector) ## hard to read
...
```{r Exercise 3.4}
## add code here!
name <- "Natalie" ## character
typeof(name)
age <- 20 ## double
typeof(age)
birthday <- "12/23/2002" ## character
typeof(birthday)
three_fav_colors <- c("Yellow", "Orange", "Green") ## character
